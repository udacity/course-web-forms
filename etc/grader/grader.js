...
Grader.prototype = {
  ...
  // jQuery elem, string tag. returns true if elem collection contains one instance of a tag.
  ...
  // jquery elem. string className. returns true if elem includes an elem w/className.
  ...
  // jquery elem. string id. returns true if elem includes an element w/id.
  ...
  // jquery elem. string text. returns true if elem has the right text.
  ...
  // jquery elem. string attrName, string correctAttr. If elem is a collection, all elems must have the attr
  hasCorrectAttr: function (elem, attrName, correctAttr) {
    var isCorrect = false;
    if (!this.isjQuery(elem)) {
      elem = $(elem);
    }
  ...
  hasCorrectLength: function (collection, _length) {
    if (!this.isjQuery(elem)) {
      elem = $(elem);
    }
  ...
  // string func. returns true if the method has been called inside the student code.
  ...
  // string css selector elem., parentElem. returns true if elem (or multiple elems) exists as a child (or deep child) of parentElem.
  ...
  // string css selector elem, parentElem. returns true if elem does not exist as a child (or deep child) of parentElem.
  ...
  // string css selector elem. jquery parentElem. returns true if elem (or multiple matched elems) exists as an immediate child of parentElem.
  isImmediateChild: function (elem, parentElem) {
    ...
    if (parentElem.children(elem).length > 0) return true;
    return false;
  }
}
